...
$string['menuoption'] = 'lixin1 MEM Plugin (DEV build)';
$string['pluginname'] = 'lixin1 MEM Plugin (DEV)';
$string['thesymmtricalspoon_lixin1:add'] = 'You do not have permission to use the feeback';
