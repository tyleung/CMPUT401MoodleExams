...
$string['menuoption'] = 'tyleung MEM Plugin (DEV build)';
$string['pluginname'] = 'tyleung MEM Plugin (DEV)';
$string['thesymmtricalspoon_tyleung:add'] = 'You do not have permission to use the feeback';
