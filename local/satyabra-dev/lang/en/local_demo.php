...
$string['menuoption'] = 'styabra MEM Plugin (DEV build)';
$string['pluginname'] = 'styabra MEM Plugin (DEV)';
$string['thesymmtricalspoon_satyabra:add'] = 'You do not have permission to use the feeback';
