...
$string['menuoption'] = 'ehill MEM Plugin (DEV build)';
$string['pluginname'] = 'ehill MEM Plugin (DEV)';
$string['thesymmtricalspoon_ehill:add'] = 'You do not have permission to use the feeback';
